...
![Icon](https://raw.githubusercontent.com/isXander/AdaptiveTooltips/1.19/src/main/resources/icon.png)
...
There are two modes for this option: `Screen Width`, where the mod wraps allowing lines to fill a 
maximum of your screen width (intended to be paired with **Bedrock Centering**), and `Remaining Width`,
